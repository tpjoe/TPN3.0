#!/usr/bin/env python
"""
Simple script to train CT model on survival data
"""
import sys
import subprocess
import numpy as np
...
def main(repeats=1, max_epochs=1):
    ...
    for repeat in range(repeats):
        ...
        # Run simple_autoregressive_predict_survival.py
        print(f"\nRunning simple_autoregressive_predict_survival.py for repeat {repeat + 1}...")
        predict_cmd = [sys.executable, "simple_autoregressive_predict_survival.py"]
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description='Train CT model on survival data')
